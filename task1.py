...
dict = {}
d = 1
with open('phonbook.txt', 'r', encoding='utf-8') as file:
    for i in file:
        i = i.replace('\n', '')
        dict[d] = list(i.split(';'))
        d += 1
...
save = ['кузькин', 'юрш', '3754643838383']
save2 = ['иван', 'иванов', '375445452646']
...
with open('phonbook.txt', 'w', encoding='utf-8') as file:
    for k in dict:
